...
//User inputs 1 or q.
var menuOption = readlineSync.question("Enter '1' to check even or odd and 'q' to quit.");
...
case '1': //checking for even or odd
    var inputNumber = readlineSync.question("Input number to check if it's even- ");
    if(inputNumber%2 == 0){
