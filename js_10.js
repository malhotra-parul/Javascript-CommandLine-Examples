...
//User inputs 1 or q.
var menuOption = readlineSync.question("Enter '1' to check for leap year and 'q' to quit.");
...
case '1': //checking for even or odd
    var inputNumber = readlineSync.question("Input Year in yyyy format to check if it's a leap year- ");
    if(inputNumber%4 == 0){
